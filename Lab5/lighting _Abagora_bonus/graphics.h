...
void initgraph(void)
{
	...
	PEN = getPen(PS_SOLID, 100, RGB(255,255,255));
	StdOut = GetStdHandle(STD_OUTPUT_HANDLE);


}

//void myInitgraph(int _size,int _r, int _g,int _b)
//{
//
//	mov = 30;
//	movx = 0;
...
//    GetWindowRect(hWnd,&pRECT);
//    hDC = GetWindowDC(hWnd);
//	PEN =getPen(PS_SOLID, _size, RGB(_r,_g,_b));
//	StdOut = GetStdHandle(STD_OUTPUT_HANDLE);
//
//}
...
void setcolor(int color)
{
	...
	switch (color)
	{
		case 0: PEN = getPen(PS_SOLID, 2, RGB(12,12,12)); break; ////// I changed the rgb of black to 12,12,12 to give the same black color of the console
...
///////////////////this an overloading of the setcolor function to change the size of the pen
void setcolor(int color,int _sizeOfPen)
{
	...
	switch (color)
	{
		case 0: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(12,12,12)); break;
		case 1: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,0,128)); break;
		case 2: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,128,0)); break;
		case 3: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(128,0,0)); break;
		case 4: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,128,128)); break;
		case 5: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(128,0,128)); break;
		case 6: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(128,128,0)); break;
		case 7: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,0,255)); break;
		case 8: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,255,0)); break;
		case 9: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(255,0,0)); break;
		case 10: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(0,255,255)); break;
		case 11: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(255,0,255)); break;
		case 12: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(255,255,0)); break;
		case 13: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(192,192,192)); break;
		case 14: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(192,192,192)); break;
		case 15: PEN = getPen(PS_INSIDEFRAME, _sizeOfPen, RGB(255,255,255)); break;
	}
}
